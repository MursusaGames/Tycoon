...
public class FarshMachineWorcer : MonoBehaviour
{
    ...
    [SerializeField] private GameObject fishInFarsh;
    ...
    {
        agent.speed = 3.5f + data.userData.farshMashineSpeedLevel / 20f;   //изменяем скорость работника от 3.5 до 7
        fishSpeed = 1.0f + (data.userData.farshMashineSpeedLevel * Constant.speedDecreeseKoeff * data.userData.ADSpeedMultiplier);
        _fishOutDelay = fishOutDelay - data.userData.farshMashineSpeedLevel / 25;
    }
